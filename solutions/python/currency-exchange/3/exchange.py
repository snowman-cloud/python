...
def get_change(budget, exchanging_value):
    ...
    left_currency = budget - exchanging_value
...
def get_number_of_bills(amount, denomination):
    ...
    currency_num = amount//denomination
    return currency_num
...
def get_leftover_of_bills(amount, denomination):
    ...
    leftover_amount = amount - denomination * get_number_of_bills(amount,denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    money = exchange_money(budget,exchange_rate)
    max_value = get_number_of_bills(money,denomination)*denomination
    return max_value
