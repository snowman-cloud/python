...
def get_value_of_bills(denomination, number_of_bills):
    ...
    get_value_of_bills = int(denomination*number_of_bills)
...
def get_leftover_of_bills(amount, denomination):
    ...
    get_leftover_of_bills = amount - denomination * get_number_of_bills(amount,denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchangeable_value = get_number_of_bills(money,denomination)*denomination
